...
This is my first personal portfolio website, built using **pure HTML and CSS**.
...
- **Float-based layout** for practicing traditional layout techniques
...
The project is created as a training exercise to practice and demonstrate fundamental front-end skills while applying clean code principles and responsive design.
